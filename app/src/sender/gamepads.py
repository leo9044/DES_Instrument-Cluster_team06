...
class ShanWanGamepadInput:
    def __init__(self) -> None:
        ...
        self.button_l1: Optional[float] = None
        self.button_l2: Optional[float] = None
        self.button_r1: Optional[float] =  None
        self.button_r2: Optional[float] = None
        self.button_x: Optional[bool] = None
        self.button_a: Optional[bool] = None
        self.button_b: Optional[bool] = None
        self.button_y: Optional[bool] = None 
        self.button_select: Optional[bool] = None 
        self.button_start: Optional[bool] = None
        self.button_home: Optional[bool] = None
